...
import { get_visible_screen } from "./video";
...
let tms_counter = 0;
let tms9928_canvas = document.getElementById("canvas_tms9928") as HTMLCanvasElement;
let tms9928_context = tms9928_canvas.getContext('2d') as CanvasRenderingContext2D;
...
export function calculateGeometry_tms9928() {
   ...
   let screen = document.getElementById("screen_tms9928") as HTMLElement;
   screen.style.display = get_visible_screen() == "tms9928" ? "block" : "none";
}

// called back by WASM at the end of each video frame
function tms9928_screen_update(ptr: number) {
...
(window as any).tms9928_screen_update = tms9928_screen_update;